        ...
        <div class="modal-content bg-white rounded-xl p-8 shadow-lg border-0" style="overflow: visible;">
            ...
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="customer_id" value="{{ old('customer_id') }}" required style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter your ID">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter your name">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required  style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter your email">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter your phone">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="address" value="{{ old('address') }}" style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter your address">
