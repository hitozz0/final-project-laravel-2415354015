        ...
        <div class="modal-content bg-white rounded-xl p-8 shadow-lg border-0" style="overflow: visible;">
            ...
            <form id="editServiceForm" action="{{ session('edit_service_id') ? route('services.update', session('edit_service_id')) : '' }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="edit_service_name" name="name" value="{{ old('name') }}" style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter service name">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="edit_service_price" name="price" value="{{ old('price') }}" style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter price">
                ...
                <div class="mb-4">
                    ...
                    <textarea rows="3" id="edit_service_description" name="description" style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none; resize: none;" placeholder="Enter description">{{ old('description') }}</textarea>
